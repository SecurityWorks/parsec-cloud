...
.. _Parsec CLI v3.2.5-a.0.dev.20137+561f26e: https://github.com/Scille/parsec-cloud/releases/download/v3.2.5-a.0.dev.20137+561f26e/parsec-cli_3.2.5-a.0.dev.20137+561f26e_linux_x86_64

1. Download the CLI by following this link:

   `Parsec CLI v3.2.5-a.0.dev.20137+561f26e`_.
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.2.5-a.0.dev.20137+561f26e_linux_x86_64

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.2.5-a.0.dev.20137+561f26e_linux_x86_64 --version

  The CLI should output its version:

  .. code-block::

      parsec-cli 3.2.5-a.0.dev.20137+561f26e
