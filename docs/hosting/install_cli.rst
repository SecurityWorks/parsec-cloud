...
.. _Parsec CLI v3.4.1-a.0.dev.20301+23216fd: https://github.com/Scille/parsec-cloud/releases/download/v3.4.1-a.0.dev.20301+23216fd/parsec-cli_3.4.1-a.0.dev.20301+23216fd_linux-x86_64-musl

1. Download the CLI by following this link:

   `Parsec CLI v3.4.1-a.0.dev.20301+23216fd`_.
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.4.1-a.0.dev.20301+23216fd_linux-x86_64-musl

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.4.1-a.0.dev.20301+23216fd_linux-x86_64-musl --version

  The CLI should output its version:

  .. code-block::

      parsec-cli 3.4.1-a.0.dev.20301+23216fd
