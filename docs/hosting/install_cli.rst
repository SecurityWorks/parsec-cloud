...
.. _Parsec CLI v3.2.5-a.0.dev.20123+2fbf772: https://github.com/Scille/parsec-cloud/releases/download/v3.2.5-a.0.dev.20123+2fbf772/parsec-cli_3.2.5-a.0.dev.20123+2fbf772_linux_x86_64

1. Download the CLI by following this link:

   `Parsec CLI v3.2.5-a.0.dev.20123+2fbf772`_.
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.2.5-a.0.dev.20123+2fbf772_linux_x86_64

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.2.5-a.0.dev.20123+2fbf772_linux_x86_64 --version

  The CLI should output its version:

  .. code-block::

      parsec-cli 3.2.5-a.0.dev.20123+2fbf772
