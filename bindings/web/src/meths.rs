...
fn struct_available_device_js_to_rs(obj: JsValue) -> Result<libparsec::AvailableDevice, JsValue> {
    ...
    let ty = {
        ...
        variant_device_file_type_js_to_rs(js_val)?
    };
...
fn struct_available_device_rs_to_js(
    ...
    let js_ty = variant_device_file_type_rs_to_js(rs_obj.ty)?;
...
#[allow(dead_code)]
fn variant_realm_role_js_to_rs(obj: JsValue) -> Result<libparsec::RealmRole, JsValue> {
...
#[allow(dead_code)]
fn variant_realm_role_rs_to_js(rs_obj: libparsec::RealmRole) -> Result<JsValue, JsValue> {
    let js_obj = Object::new().into();
    match rs_obj {
...
#[allow(dead_code)]
fn variant_user_profile_js_to_rs(obj: JsValue) -> Result<libparsec::UserProfile, JsValue> {
    let tag = Reflect::get(&obj, &"tag".into())?;
    match tag {
...
#[allow(dead_code)]
fn variant_user_profile_rs_to_js(rs_obj: libparsec::UserProfile) -> Result<JsValue, JsValue> {
    let js_obj = Object::new().into();
    match rs_obj {
...
#[allow(dead_code)]
fn variant_device_file_type_js_to_rs(obj: JsValue) -> Result<libparsec::DeviceFileType, JsValue> {
    let tag = Reflect::get(&obj, &"tag".into())?;
    match tag {
...
#[allow(dead_code)]
fn variant_device_file_type_rs_to_js(
...
#[allow(dead_code)]
fn variant_invitation_status_js_to_rs(
    obj: JsValue,
...
#[allow(dead_code)]
fn variant_invitation_status_rs_to_js(
...
#[allow(dead_code)]
fn variant_invitation_email_sent_status_js_to_rs(
    obj: JsValue,
...
#[allow(dead_code)]
fn variant_invitation_email_sent_status_rs_to_js(
    ...
    match tag {
        tag if tag == JsValue::from_str("Device") => {
            ...
            let status = {
                ...
                variant_invitation_status_js_to_rs(js_val)?
            };
...
fn variant_invite_list_item_rs_to_js(
    ...
    match rs_obj {
        libparsec::InviteListItem::Device {
            ...
            let js_status = variant_invitation_status_rs_to_js(status)?;
...
pub fn clientWorkspaceShare(
    ...
    future_to_promise(async move {
        ...
        let role = match role {
            Some(role) => {
                let role = role.into();
                let role = variant_realm_role_js_to_rs(role)?;
        ...
        Ok(match ret {
            Ok(value) => {
                ...
                let js_value = {
                    ...
                    js_array.push(&js_value);
                    let js_value = variant_invitation_email_sent_status_rs_to_js(x2)?;
                    js_array.push(&js_value);
                    js_array.into()
                };
                Reflect::set(&js_obj, &"value".into(), &js_value)?;
...
pub fn greeterUserInProgress4DoCreate(
    ...
    future_to_promise(async move {
        ...
        let profile = variant_user_profile_js_to_rs(profile)?;
