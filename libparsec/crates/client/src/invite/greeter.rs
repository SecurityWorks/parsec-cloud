...
pub async fn new_user_invitation(
    ...
    use authenticated_cmds::latest::invite_new_user::{Rep, Req, InvitationEmailSentStatus as ApiInvitationEmailSentStatus};
    ...
    match rep {
        Rep::Ok { token, email_sent } => {
            let email_sent = match email_sent {
                ...
                ApiInvitationEmailSentStatus::ServerUnavailable => InvitationEmailSentStatus::ServerUnavailable,
                ApiInvitationEmailSentStatus::RecipientRefused => InvitationEmailSentStatus::RecipientRefused,
            };
            Ok((token, email_sent))
        },
...
pub async fn new_device_invitation(
    ...
    use authenticated_cmds::latest::invite_new_device::{Rep, Req, InvitationEmailSentStatus as ApiInvitationEmailSentStatus};
        ...
        let invite_user_confirmation = loop {
...

            {
                ...
                match rep {
                    ...
                    Rep::HumanHandleAlreadyTaken => Err(GreetInProgressError::HumanHandleAlreadyTaken),
